...
| 🌡️ 环境状态 | System Temperature                             |

> 指标被归并成 10 个稳定图表族，减少碎片化信息和无意义的重复展示。
...
- 官方、基础、运维、资源、财务、流量、资产、完整和自定义总览方案
...
| 总览卡片       | 9 套方案、自定义 keys 和显示顺序                    |
| 高级工具与隐私 | 工具总开关、隐藏后台 / 价格、厂商别名、导出二级密码 |
| 快捷控制与列表 | 快捷按钮、列表元数据、离线置底、预警阈值            |
| 详情概览       | 17 类指标卡、6 套方案、分区标签页                   |
| 详情图表       | 10 个图表族、8 套方案和自定义 keys                  |
