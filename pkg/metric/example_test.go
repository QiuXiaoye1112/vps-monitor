...
import (
	...
	"github.com/monitor-monitor/monitor/pkg/metric"
)
...
// Example_agentFleetLifecycle demonstrates a realistic Monitor-style fleet:
...
//
// Example_agentFleetLifecycle 演示贴近 Monitor 的实际场景：50 个 agent 每秒上报系统
