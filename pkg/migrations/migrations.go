...
const trafficCarryMigrationKey = "migration_traffic_carry_v2"
...
// BackfillTrafficCarry separates historical traffic retained by the cleanup
// process from the compensation value explicitly managed by the user.
//
